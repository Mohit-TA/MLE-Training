...
if __name__ == "__main__":
    ...
    mse, rmse, mae, r2 = score(os.path.join(model_path, "LinearRegression"), x_test, y_test)
    logger.debug(f"Linear Regression -> r2= {r2} , mse= {mse} , rmse= {rmse}, mae= {mae}")
    mse, rmse, mae, r2 = score(
        os.path.join(model_path, "DecisionTreeRegression"), x_test, y_test
    )
    logger.debug(f"Decision Tree Regression -> r2={r2},mse= {mse} , rmse= {rmse}, mae= {mae}")
    mse, rmse, mae, r2 = score(
    ...
    logger.debug(
        f"RandomForestRegressor RandomSearch -> r2= {r2},mse= {mse} , rmse= {rmse}, mae= {mae}"
    )
    mse, rmse, mae, r2 = score(
        os.path.join(model_path, "randomForestRegressor_GridSearch"), x_test, y_test
    )
    logger.debug(
        f"RandomForestRegressor GridSearch -> r2= {r2},mse= {mse} , rmse= {rmse}, mae= {mae}"
    )
