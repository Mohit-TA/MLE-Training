...
def income_cat_proportions(data):
    """
    This function creates 'income_cat_proporation' column
    :param = take the dataframe
    :return = proportion of incaome cateogry value
    """
...
def split(housing):
    """
    Split the compelete data into train and test with split ration of 0.8-0.2
    :param = Takes the complete data set.
    :return = return splitted train and test data
    """
...
def preprocess(strat_train_set):
    """
    Creates the new feature like 'median_house_value' and more.
    Then impution is perfomed with missing value is replaced with median.
    Later any unwanted columns are dropped and categorical column are converted into numerical binary columns
    or dummy variables.
    :param =  Train data
    :return = new transformed dataset
    """
